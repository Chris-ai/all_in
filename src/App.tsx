...
function PlayerView() {
  ...
  if (showStart) return <main className="start-screen"><div className="stage-rays" />{leaderboard}<section><div className="start-qr"><img src={startQrUrl} alt={`Kod QR prowadzący do ${playUrl}`} /></div><button type="button" onClick={startGame}>Rozpocznij grę <span>→</span></button></section></main>
